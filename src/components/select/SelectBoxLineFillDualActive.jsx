...
const SelectBoxLineFillDualActive = ({ wrapClass, placeholder1, placeholder2 }) => {
    ...
    const [selbox2, setSelbox2] = useState(true);
    const handleFocus2 = () => {
        setSelbox2(!selbox2);
    }
    const closeBox2 = () => {
        ...
        <section className={wrapClass}>
            ...
            <div className="dflx_ac gap_8">
                ...
                <div onFocus={handleFocus2} className={selbox2? "selectbox w88 line fill h28 gap_8 on" : "selectbox w88 line fill h28 gap_8"}>
                    <input type="text" className="selectbox_text" value={'Active'} onChange={onChangeValue2} placeholder={placeholder2} />
                    <ImgComponent className="op06 w16 selectbox_arrow" src={'arrow_down_fff_16.svg'} />
                    <ul className="selectbox_options scroll">
                        <li onClick={SelectValue2} className="option on">label1</li>
...
export default SelectBoxLineFillDualActive;
