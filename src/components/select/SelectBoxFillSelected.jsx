...
const SelectBoxFillSelected = ({ wrapClass, placeholder, disabled, value }) => {
    ...
    return (
        <section className={wrapClass}>
            ...
            <div onFocus={handleFocus} className={selbox? "selectbox w200 fill h28 gap_8 on" : "selectbox w200 fill h28 gap_8"}>
                <input type="text" className="selectbox_text" value={'Selected'} onChange={onChangeValue} placeholder={placeholder} disabled={disabled} />
...
export default SelectBoxFillSelected;
