...
const SelectBoxLineFillSelected = ({ wrapClass, placeholder, disabled, value }) => {
    ...
    return (
        <section className={wrapClass}>
            ...
            <div onFocus={handleFocus} className={selbox? "selectbox w200 line fill h28 gap_8 on" : "selectbox w200 line fill h28 gap_8"}>
                <input type="text" className="selectbox_text" value={value} onChange={onChangeValue} placeholder={placeholder} disabled={disabled} />
...
export default SelectBoxLineFillSelected;
