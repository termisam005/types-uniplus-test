...
const InputLargeComponent = ({ zoneClass, type, placeholder, messClass, message }) => {
    ...
    return (
        <div className={zoneClass}>
            <input type={type} className={idInput? 'wrput large p-r-32' : 'wrput large'} placeholder={placeholder} value={id} onChange={writePut} />
